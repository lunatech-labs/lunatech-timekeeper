...
/*
        ...
        void shouldFindAllProjectsV1() {
           ...
           /* final UserRequest user = new UserRequest("Sam", "Huel", "sam@gmail.com", "sam.png", of(Admin));
            ...
            final ProjectRequest project1 = new ProjectRequest("Pepito", true, "New project", 3L, false, emptyList());
            given()
                    .auth().preemptive().oauth2(token)
                    .when()
                    .contentType(APPLICATION_JSON)
            ...
            final ProjectResponse expectedProject = new ProjectResponse(4L, "Pepito", true, "New project", new ProjectResponse.ProjectClientResponse(3L, "Pepito"), emptyList(), false);
            final ProjectResponse expectedProject1 = new ProjectResponse(5L, "Pepito", true, "New project", new ProjectResponse.ProjectClientResponse(3L, "Pepito"), emptyList(), false);
            given()
                    .auth().preemptive().oauth2(token)
                    .when()
                    .header(ACCEPT, APPLICATION_JSON)
