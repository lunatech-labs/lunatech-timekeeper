...
class ProjectResourceTest {
    ...
    void shouldIncrementTheProjectVersionNumbeWhenUpdated() {
        ...
        // WHEN
        update(newProjectVersion01, ProjectDef.uriWithid(originalProject.getId()), adminToken);
        update(updatedVersion02, ProjectDef.uriWithid(originalProject.getId()), adminToken);
    ...
    void shouldRejectAnUpdateOnAProjectIfItWasAlreadyUpdated() {
        ...
        given()
                ...
                .put(ProjectDef.uriWithid(originalProject.getId()))
                .then()
