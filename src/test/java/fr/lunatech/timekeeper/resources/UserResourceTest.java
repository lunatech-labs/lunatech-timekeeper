...
class UserResourceTest {
    ...
    void shouldNotCreateUserWhenEmailAlreadyExists() {
        ...
        final UserRequest user2 = new UserRequest("Sam2", "Huel2", "sam@gmail.com", "sam.png", List.of(Admin));
        given()
                .auth().preemptive().oauth2(token)
                .when()
                .contentType(APPLICATION_JSON)
    ...
    void shouldModifyUserWhenAdminProfile() {
        ...
        final UserRequest user2 = new UserRequest("Sam2", "Huel2", "sam@gmail.com", "sam2.png", List.of(User));
        given()
                .auth().preemptive().oauth2(token)
                .when()
                .contentType(APPLICATION_JSON)
    ...
    void shouldNotModifyUserEmail() {
        ...
        final UserRequest user2 = new UserRequest("Sam2", "Huel2", "sam2@gmail.com", "sam2.png", List.of(User));
        given()
                .auth().preemptive().oauth2(token)
                .when()
                .contentType(APPLICATION_JSON)
