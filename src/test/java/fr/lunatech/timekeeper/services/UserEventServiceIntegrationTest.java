...
class UserEventServiceIntegrationTest {
    ...
    void shouldGetEventsByUserForAWeekNumber() {
        ...
        EventTemplateRequest newEventTemplate = dataEventProvider.generateEventTemplateRequest("Event Name 1", THE_24_TH_JUNE_2020_AT_9_AM, THE_24_TH_JUNE_2020_AT_5_PM, userSam.getId());
    ...
    void shouldGetAnEmptyListOfEventsByUserForAWrongWeekNumber() {
        ...
        //WHEN: an eventTemplate is created with the 1 attendee
        EventTemplateRequest newEventTemplate = dataEventProvider.generateEventTemplateRequest("Event Name 3", THE_24_TH_JUNE_2020_AT_9_AM, THE_24_TH_JUNE_2020_AT_5_PM, userSam.getId());
        create(newEventTemplate, adminToken);
    ...
    void shouldGetAnEmptyListOfEventsByUserForAWrongMonthNumber() {
        ...
        //WHEN: an eventTemplate is created with the 1 attendee
        EventTemplateRequest newEventTemplate = dataEventProvider.generateEventTemplateRequest("Event Name 4", THE_24_TH_JUNE_2020_AT_9_AM, THE_24_TH_JUNE_2020_AT_5_PM, userSam.getId());
        create(newEventTemplate, adminToken);
        var expected = List.of();
